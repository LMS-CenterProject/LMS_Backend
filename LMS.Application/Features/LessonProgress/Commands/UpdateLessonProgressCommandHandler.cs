...
namespace LMS.Application.Features.LessonProgress.Commands
{
    ...
    : IRequestHandler<LMS.Application.Features.Progress.Commands.UpdateLessonProgress.UpdateLessonProgressCommand, Result<UpdateProgressResultDto>>
    {
        public async Task<Result<UpdateProgressResultDto>> Handle(
            LMS.Application.Features.Progress.Commands.UpdateLessonProgress.UpdateLessonProgressCommand cmd, CancellationToken ct)
        {
